...
class ShadowHandCfg(BaseRobotCfg):
    ...
    actuators: dict[str, BaseActuatorCfg] = {
        "robot0_WRJ1": BaseActuatorCfg(stiffness=5.0),
        "robot0_WRJ0": BaseActuatorCfg(stiffness=5.0),
        "robot0_FFJ3": BaseActuatorCfg(stiffness=1.0),
        "robot0_FFJ2": BaseActuatorCfg(stiffness=1.0),
        "robot0_FFJ1": BaseActuatorCfg(stiffness=1.0),
        "robot0_FFJ0": BaseActuatorCfg(stiffness=1.0),
        ...
        "robot0_MFJ0": BaseActuatorCfg(stiffness=1.0),
        ...
        "robot0_RFJ0": BaseActuatorCfg(stiffness=1.0),
        ...
        "robot0_LFJ0": BaseActuatorCfg(stiffness=1.0),
